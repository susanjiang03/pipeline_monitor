...
urlpatterns = patterns('',
    ...
    url(r'^newspaper/(?P<newspaperlink>\w{0,50})/category/(?P<thiscategory>\w{0,50})/$', views.newspaper_category, name='newspaper_category'),
    url(r'^filterfeeds$', views.filterfeeds, name='filterfeeds'),
    url(r'^userfeeds$', views.userfeeds, name='userfeeds'),
    url(r'^newuserfeeds$', views.newuserfeeds, name='newuserfeeds'),
    ...
    url(r'^images/(?P<urlid>[0-9]+)$', views.image_text, name='image_text'),
    url(r'^allimages$', views.allarticles, name='allarticles'),
